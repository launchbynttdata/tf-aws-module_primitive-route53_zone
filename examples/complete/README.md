...
| <a name="input_enable_accelerated_recovery"></a> [enable\_accelerated\_recovery](#input\_enable\_accelerated\_recovery) | Whether to enable accelerated recovery for the hosted zone. | `bool` | `false` | no |
